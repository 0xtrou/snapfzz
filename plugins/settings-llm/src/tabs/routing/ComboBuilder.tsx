  ...
  return (
    <div style={{ maxWidth: 480 }}>
      <div style={{ marginBottom: 20 }}>
        <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: 'var(--text-secondary)', marginBottom: 6, textTransform: 'none',  }}>
          Combo Name
        </label>
        <Input
          value={name}
...
function StepDeployments({
  ...
  return (
    <div style={{ maxWidth: 560 }}>
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-secondary)', textTransform: 'none',  marginBottom: 8 }}>
          API Type
        </div>
        <Radio.Group
          value={apiType}
      ...
      <div style={{ marginBottom: 16 }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-secondary)', textTransform: 'none',  marginBottom: 6 }}>
          Select Models
        </div>
  ...
  return (
    <div>
      ...
      {strategy === 'weighted' && deployments.length > 0 && (
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4, textTransform: 'none',  }}>
            Weights
          </div>
...
function StepReview({
  ...
  return (
    <div style={{ maxWidth: 560 }}>
      ...
      >
        <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--text-primary)', textTransform: 'none',  marginBottom: 10 }}>
          Validation
        </div>
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-primary)', textTransform: 'none' }}>
