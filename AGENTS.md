...
This project is indexed by GitNexus as **snapfzz-startup-launcher** (2135 symbols, 4994 relationships, 163 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
