...
This project is indexed by GitNexus as **snapfzz-startup-launcher** (2965 symbols, 7244 relationships, 235 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
