...
This project is indexed by GitNexus as **snapfzz-startup-launcher** (3637 symbols, 8923 relationships, 291 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
