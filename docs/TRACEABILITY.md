...
| Project shell renders plugin contributions via ContributionStore (empty of direct plugin imports per A005) | frontend/packages/project/src/app/App.tsx | frontend/packages/project/src/app/App.test.tsx:A006/shell: renders structural shell areas; A006/shell: uses plugin host provider wrapper; A006/shell: renders contribution tabs when store has data |
| Launcher shell renders plugin contributions via ContributionStore (empty of direct plugin imports per A005) | frontend/packages/launcher/src/app/App.tsx | frontend/packages/launcher/src/app/App.test.tsx:A006/shell: renders plugin host provider wrapper; A006/shell: renders launcher generic components from contributions |
| Launcher shell skeleton in index.html visible at 0ms, fades on React hydration | frontend/packages/launcher/index.html + frontend/packages/launcher/src/app/App.tsx (useEffect) | frontend/packages/launcher/src/app/App.test.tsx:A003/InstantLoading: sets data-app-ready on hydration; A003/InstantLoading: adds fade-out class to skeleton element |
| Project shell skeleton in index.html visible at 0ms, fades on React hydration | frontend/packages/project/index.html + frontend/packages/project/src/app/App.tsx (useEffect) | frontend/packages/project/src/app/App.test.tsx:A003/InstantLoading: sets data-app-ready on hydration; A003/InstantLoading: adds fade-out class to skeleton element |
| Startup metrics: LCP, long tasks, TTI measured on every boot | frontend/packages/launcher/src/app/App.tsx:measureStartup() | console output [A003/metrics] during test runs |
| Test plugin demonstrates runtime discovery pattern (not shell-registered) | plugins/test-plugin/src/index.ts | — |
